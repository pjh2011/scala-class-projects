...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  var tweetString = $as_T(tweetText.apply__O());
  var remaining_chars = ((140 - this.tweetLength__p1__T__I(tweetString)) | 0);
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remaining_chars$1) {
    return (function() {
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  var chars_remaining = $uI(remainingCharsCount.apply__O());
  var tweet_color = ((chars_remaining >= 15) ? "green" : ((chars_remaining >= 0) ? "orange" : "red"));
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(tweet_color$1) {
    return (function() {
      return tweet_color$1
    })
  })(tweet_color));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
